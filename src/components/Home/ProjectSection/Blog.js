...
let modalShow =
  'absolute lg:left-[6%] md:left-14 md:h-1/2 md:w-2/3 shadow-2xl lg:shadow-none md:left-5 top-[50%] backdrop-blur-sm   rounded-xl lg:w-3/5 xl:w-3/5  2xl:w-2/5 lg:h-2/3  lg:h-1/2 lg:bg-zinc-900  py-4 px-8 transition-all scale-100 origin-right duration-1000 ';
let modalHide =
  'absolute lg:left-[6%] md:left-5 top-[50%] md:backdrop-blur-sm rounded-xl lg:w-3/5 xl:w-4/5   2xl:w-3/5 lg:h-2/3 lg:h-1/2   py-4 px-8 transition-all scale-0 origin-right duration-1000 ';
  ...
  return (
    <>
      ...
      <ParallaxLayer offset={3} speed={0.9}>
        <video
          className=" absolute top-[50%] md:right-0 lg:right-10  2xl:right-32 w-full   h-2/3 sm:w-[95%] lg:w-4/5 xl:w-4/5 2xl:w-3/5  shadow-md   rounded-lg  z-30 object-cover"
          autoPlay={true}
          loop={true}
          muted={true}
        >
