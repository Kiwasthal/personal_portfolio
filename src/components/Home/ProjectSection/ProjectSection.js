  ...
  return (
    <>
      <ParallaxLayer offset={3} speed={0.9}>
        <video
          className="absolute   top-[50%]  lg:right-32 w-full   h-2/3 sm :w-[95%] lg:w-3/5  shadow-md   rounded-lg  z-30 object-cover"
          autoPlay={true}
          loop={true}
          muted={true}
        >
      ...
      <ParallaxLayer offset={3} speed={0.5}>
        <div className="absolute lg:left-52 md:left-4  sm:w-4/5  lg:w-2/5 top-[50%] w-2/5 h-2/5 border-dotted border-4 border-rose-600 z-30 flex flex-col"></div>
      </ParallaxLayer>
      <ParallaxLayer offset={3} speed={0.2}>
        <div className="absolute lg:left-56 md:left-5 top-[50%]  rounded-xl w-[772px] h-96  bg-zinc-900 py-4 px-8">
          <div className="flex justify-between items-end">
            <h3 className="text-4xl text-white font-bold">Kiwasthal Blog</h3>
